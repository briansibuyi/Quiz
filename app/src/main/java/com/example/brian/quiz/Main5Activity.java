...
import static com.example.brian.quiz.Main6Activity.score;
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (increamentVar <=9) {
                    ...
                    Intent myintent = new Intent(Main5Activity.this,Main10Activity.class);
    ...
    void Time(){
        new CountDownTimer(120000,1000){
            ...
            public void onFinish() {
                ...
                Intent myint= new Intent(Main5Activity.this,Main10Activity.class);
                startActivity(myint);
            }
